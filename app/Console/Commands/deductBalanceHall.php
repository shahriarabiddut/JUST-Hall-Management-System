...
class deductBalanceHall extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:deduct-balance-hall';
    ...
    public function handle(): void
    {
        ...
        foreach ($halls as $hall) {
            ...
            //
            $users = Student::all()->where('hall_id', $hall->id)->where('status', '1');
            foreach ($users as $user) {
                ...
                $data = Balance::all()->where('student_id', '=', $student_id)->where('hall_id', $hall->id)->first();
                if ($data != null) {

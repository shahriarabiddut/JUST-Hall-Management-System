...
class OrderController extends Controller
{
    ...
    public function print(string $id)
    {
        ...
        // Set params
        $mid = "Staff : " . Auth::guard('staff')->name;
        ...
        if ($printer->printReceipt() == 'null') {
            return redirect()->route('staff.orders.index')->with('danger', ' Somethings Wrong!Printer & Wifi is not on Same IP!');
        } else {
            // Print Reciept 
            ...
            $data->status = 1;
            $data->save();
            return redirect()->route('staff.orders.index')->with('success', ' Token Printed!');
        }
    }
}

...
<!-- Session Messages Ends -->
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="{{ url('admin/orders') }}" class="float-right btn btn-success btn-sm"> <i class="fa fa-arrow-left"></i> View All </a> </h6>
        </div>
        <div class="card-body bg-danger text-white p-2">
            <h1 class="text-center font-weight-bold">Time Passed & Meal Cannot Be Served</h1>
        </div>
        <div class="card-body">

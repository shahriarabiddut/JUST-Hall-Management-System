...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="{{ url('admin/roomtype') }}" class="float-right btn btn-success btn-sm"> <i class="fa fa-arrow-left"></i> View All </a> </h3>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                @endforeach
                @endif
            <form onsubmit="handleSubmit(event)"  method="POST" action="{{ route('admin.roomtype.store') }}" enctype="multipart/form-data">
                @csrf

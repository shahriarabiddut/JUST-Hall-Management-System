            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <p class="text-muted mb-0">{{ $user->dept }}</p>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <p class="text-muted mb-0">{{ $user->session }}</p>
                    </div>
                  </div>
                  <hr>
              <div class="row">
              ...
              <div class="row">
                <div class="col-sm-3 float-left">
                  <a href="{{ route('student.profile.edit') }}"><button type="button" class="btn btn-primary">Edit Profile</button></a>
                </div>

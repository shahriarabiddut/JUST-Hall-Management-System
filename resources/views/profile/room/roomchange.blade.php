@extends('layout')
@section('title', 'Room Change Application')
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h3 class="m-0 font-weight-bold text-primary">My Room Change Application
    ...
    <div class="card shadow mb-4">
    <div class="card-header py-3">
        <h3 class="m-0 font-weight-bold text-primary">Room Change Application
        <a href="{{ route('student.myroom') }}" class="float-right btn btn-success btn-sm"> <i class="fa fa-arrow-left"></i> View Room Details </a></h3>
    </div>
    <div class="card-body">
        ...
        <form onsubmit="handleSubmit(event)"  method="POST" action="{{ route('student.myroom.roomissue') }}" enctype="multipart/form-data">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="hidden" name="issue" value="roomchange">

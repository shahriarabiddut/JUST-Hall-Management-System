...
<body>
    ...
    <table class="table table-bordered" width="100%">
        ...
        <tr>
            ...
            <td width="50%" colspan="2" class="text-center"><img width="75px" src="{{ file_exists('storage/'.Auth::user()->roomrequest->hall->logo )? 'storage/'.Auth::user()->roomrequest->hall->logo : 'img/just.jpg'  }}" alt=""></td>
        ...
        <tr>
            <td colspan="2"><img width="150px" @if (Auth::user()->photo!=null) src="{{ 'storage/'.Auth::user()->photo }}" @else src="{{ 'images/user.png' }}" @endif alt="Application Photo"> <br>

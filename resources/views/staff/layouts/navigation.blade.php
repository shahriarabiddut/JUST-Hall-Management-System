<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('root')">
                            {{ __('Home') }}
                        </x-dropdown-link>
                        <!-- Authentication -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 dark:text-gray-200">{{ Auth::guard('staff')->user()->name }}</div>
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('root')">
                    {{ __('Home') }}
                </x-responsive-nav-link>
                <!-- Authentication -->
                <form onsubmit="handleSubmit(event)"  method="POST" action="{{ route('staff.logout') }}">

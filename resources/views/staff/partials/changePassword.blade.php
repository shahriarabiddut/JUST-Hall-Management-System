...
@section('title', ' Change Password | Staff Dashboard')
...
<!-- Page Heading -->
    ...
    <div class="table-responsive">
        ...
        @enderror
        {{-- Errors --}}
        <form onsubmit="handleSubmit(event)"  method="POST" action="{{ route('staff.profile.passwordUpdate') }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered" width="100%">  
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($data->status!='1')
                            <a onclick="return confirm('Are You Sure?')" href="{{ url('staff/roomallocation/allocate/'.$data->id) }}" class="btn btn-info btn-sm"><i class="fa fa-check" aria-hidden="true"> Allocate Sit For {{ $data2->rollno }} - Room No {{ $data->rooms->title }} </i></a>
                            @endif
                        </td>
                    </tr>
